...
sum_data$state[sum_data$state== "IA"] <- "lowa"
sum_data$state[sum_data$state== "ID"] <- "ldaho"
...
mapping <- ggplot(sum_data, aes(map_id = state)) + 
  ...
  labs(x = "", y = "") +
  theme(legend.position = "bottom", 
        panel.background = element_blank()) + labs(fill = "Number of Votes") + scale_fill_continuous(breaks = c(250000, 6270000,12204357), labels = c("240k","6270K", "12300K"))
...
mapping <- ggplot(sum_data, aes(map_id = state)) + 
  ...
  labs(x = "", y = "") +
  theme(legend.position = "bottom", 
        panel.background = element_blank()) + labs(fill = "Number of Votes") + scale_fill_continuous(breaks = c(1170000, 214200000,425544900), labels = c("240k","214200K", "426000K"))
