...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
# adding a column that say win = 1 and lose = 0
house_elections <- house_elections %>%
  mutate(winner = ifelse(ge_winner == "W", 1, 0)) 

# another 2 unnecessity columns appears so unshow it
...
```{r, message=FALSE, warning=FALSE, echo=FALSE, fig.width = 8, fig.height= 30}
...
do.call("grid.arrange", c(RD_plots, ncol=4))
